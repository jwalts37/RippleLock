...
class HighlightView {
    ...
    public void draw(Canvas canvas) {
        ...
        if (!this.mHidden) {
            ...
            if (this.mCircle) {
                ...
                float height = (float) this.mDrawRect.height();
            ...
            if (this.mCircle) {
                ...
                int height2 = this.mResizeDrawableDiagonal.getIntrinsicHeight();
                ...
                int y = ((this.mDrawRect.top + (this.mDrawRect.height() / 2)) - d) - (height2 / 2);
    ...
    public void handleMotion(int edge, float dx, float dy) {
        ...
        if (edge != 1) {
            ...
            growBy(((float) ((edge & 2) != 0 ? -1 : 1)) * dx * (this.mCropRect.width() / ((float) r.width())), ((float) ((edge & 8) != 0 ? -1 : 1)) * dy * (this.mCropRect.height() / ((float) r.height())));
        }
    }
